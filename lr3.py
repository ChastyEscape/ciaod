"""Реализовать методы поиска подстроки в строке:
    1) Кнута-Морриса-Пратта - def kmp(s, f):
    2) Упрощенный Бойера-Мура - def bm(s, f):
    (возвращают символ начала указанной подстроки начиная с 0 или -1)
"""
...
print(kmp("abcabeabcabcabd","abcabd"), 'Кнута-Морриса-Пратта')
#Упрощенный Бойера-Мура
print(bm("abcabeabcabcabd","abcabd"), 'Упрощенный Бойера-Мура')